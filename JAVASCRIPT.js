...
document.querySelector(`#binner`).innerHTML = `
    <div style="width: 1300px; height: 500px; border: 5px solid #50C878; border-radius: 10px; display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 50px; font-weight: 800; color: #4CBB17; box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px; font-family: 'Courier New', monospace;">
        ...
        <span style="font-size: 25px; font-family: 'Roboto Mono', monospace; margin-top: 10px; text-align: left;"> &#8226; You have ${start} seconds to play the game.</span>

        <span style="font-size: 25px; font-family: 'Roboto Mono', monospace; margin-top: 20px; margin-left: 30px; text-align: left;"> &#8226; Clicking on a bubble with the correct number will earn you 100 points.</span>

        <span style="font-size: 25px; font-family: 'Roboto Mono', monospace; margin-top: 20px; margin-left: 30px; text-align: left;"> &#8226; Making a wrong click on a bubble will result in a deduction of 10 points.</span>

        <span style="font-size: 25px; font-family: 'Roboto Mono', monospace; margin-top: 20px; margin-left: 30px; text-align: left;"> &#8226; Try to score as many points as you can within the given time limit.</span>
